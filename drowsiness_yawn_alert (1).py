...
##                    cv2.line(frame_1, reprojectdst[start], reprojectdst[end], (0, 0, 255))
                ...
                if euler_angle[0, 0] > 10 :
                    ...
                    cv2.putText(frame_1, "Head bend is front ",(20, 20), cv2.FONT_HERSHEY_SIMPLEX,
                            0.75, (0, 0, 255), thickness=2)
                    ##here for front bend
                if euler_angle[1, 0] > 3 :
                    print('Head bend is rigth detected ')
                    cv2.putText(frame_1, "Head bend is right detected ",(20, 20), cv2.FONT_HERSHEY_SIMPLEX,
                            0.75, (0, 0, 255), thickness=2)
                    ##here for right bend
                if euler_angle[2, 0] > 10 :
                    print('Head bend is left detected ')
                    cv2.putText(frame_1, "Head bend is left detected ",(20, 20), cv2.FONT_HERSHEY_SIMPLEX,
                            0.75, (0, 0, 255), thickness=2)
                    ##here for left bend
